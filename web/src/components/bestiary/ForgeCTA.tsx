 ...
 * The chapter's hint ids come in as a prop so this component doesn't pull
 * the prose-heavy hint modules into its chunk.
 */
export function ForgeCTA({ chapter, hintIds }: { chapter: number; hintIds: string[] }) {
